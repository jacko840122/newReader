...
public class DownManagerAdpter extends BaseAdapter {
	...
	private List<BookDownManagerActivity.Helper> mhHelpers = null;
	private boolean isDelete = false;

	public DownManagerAdpter(Context context,List<BookDownManagerActivity.Helper> mhHelpers) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		BookDownManagerActivity.Helper mHelper = (BookDownManagerActivity.Helper)getItem(position);
		final BooksDBOnInternet.BookInfo mBookInfo = mHelper.mBookInfo;
	...
	private void StartDownLoadBook(BooksDBOnInternet.BookInfo mBookInfo, DownloadBookInfo mBookInfo2) {
	...
	private void PauseDownLoadBook(BooksDBOnInternet.BookInfo mBookInfo, DownloadBookInfo mBookInfo2) {
		Intent intent = new Intent(mContext,DownLoadService.class);
	...
	private void DeleteDownLoadBook(BooksDBOnInternet.BookInfo mBookInfo, DownloadBookInfo mBookInfo2) {
		Intent intent = new Intent(mContext,DownLoadService.class);
	...
	public void updateProgress(DownloadBookInfo mDownload){
		if (mhHelpers != null) {
			for (BookDownManagerActivity.Helper mHelper:mhHelpers) {
