...
import com.common.kuaxue.utils.WindowsStyle;
...
public class BookDetailsActivity extends BaseActivity implements OnClickListener {
	...
	private BooksDBOnInternet.BookInfo mBookInfo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBookInfo = (BooksDBOnInternet.BookInfo) getIntent().getSerializableExtra("BookInfo");
		InitView();
