...
public class SearchBooksListAdpter extends BaseAdapter {
	...
	private final ArrayList<BooksDBOnInternet.BookInfo> mBookInfoList;
	private final LayoutInflater mInflater;

	public SearchBooksListAdpter(Context context,ArrayList<BooksDBOnInternet.BookInfo> BookInfoList) {
		mContext = context;
	...
	public View getView(int position,View convertView,ViewGroup parent) {
		BooksDBOnInternet.BookInfo bookInfo;
	...
	private class UpdateDownloadOrReadStatusWatcher {
		...
		final private BooksDBOnInternet.BookInfo mBookInfo;
		...
		public UpdateDownloadOrReadStatusWatcher(BooksDBOnInternet.BookInfo bookInfo, Button download_or_read_btn, ProgressBar download_progressBar, ViewGroup downloading_progressContainer, TextView download_progress_TextView){
			mBookInfo=bookInfo;
